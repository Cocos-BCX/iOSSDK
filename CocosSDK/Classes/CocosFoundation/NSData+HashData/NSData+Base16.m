...
- (id) initWithBase16EncodedString:(NSString *)base16String options:(NSDataBase16DecodingOptions)options
{
    ...
    NSData *data = [self initWithBytes:decoded length:[base16String length] / 2];
...
- (NSString *)base16EncodedStringWithOptions:(NSDataBase16EncodingOptions)options
{
    ...
    NSString *base16 = [[NSString alloc] initWithData:[NSData dataWithBytes:encoded length:self.length * 2] encoding:NSASCIIStringEncoding];
