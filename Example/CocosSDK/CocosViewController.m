...
- (IBAction)mortgageGetGas {
    ...
    [[CocosSDK shareInstance] Cocos_GasWithMortgager:self.mortgage_mortgager.text Beneficiary:self.mortgage_beneficiary.text Collateral:[self.mortgage_amout.text floatValue] Password:self.mortgage_password.text Success:^(id responseObject) {
